!function (t) {
    ...
    return function t(e, n, i) {
        ...
        2: [function (t, e, n) {
            function i(t) {
                if (t) {
                    var e = /^#([a-fA-F0-9]{3})$/, n = /^#([a-fA-F0-9]{6})$/, i = /^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/, a = /^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/, r = /(\w+)/, o = [0, 0, 0], l = 1, s = t.match(e);
                    if (s) {
                        s = s[1];
            ...
            function a(t) {
                if (t) {
                    ...
                    if (n) {
                        var i = parseFloat(n[4]), a = b(parseInt(n[1]), 0, 360), r = b(parseFloat(n[2]), 0, 100), o = b(parseFloat(n[3]), 0, 100), l = b(isNaN(i) ? 1 : i, 0, 1);
                        return [a, r, o, l];
                    }
                }
            }
        ...
        3: [function (t, e, n) {
            var i = t(5), a = t(2), r = function (t) {
                ...
                var e;
                "string" == typeof t ? (e = a.getRgba(t), e ? this.setValues("rgb", e) : (e = a.getHsla(t)) ? this.setValues("hsl", e) : (e = a.getHwb(t)) && this.setValues("hwb", e)) : "object" == typeof t && (e = t,
            ...
            r.prototype = {
                ...
                mix: function (t, e) {
                    var n = this, i = t, a = void 0 === e ? .5 : e, r = 2 * a - 1, o = n.alpha() - i.alpha(), l = ((r * o === -1 ? r : (r + o) / (1 + r * o)) + 1) / 2, s = 1 - l;
        ...
        4: [function (t, e, n) {
            function i(t) {
                ...
                return s == l ? e = 0 : a == s ? e = (r - o) / u : r == s ? e = 2 + (o - a) / u : o == s && (e = 4 + (a - r) / u),
                    e = Math.min(60 * e, 360), 0 > e && (e += 360), i = (l + s) / 2, n = s == l ? 0 : .5 >= i ? u / (s + l) : u / (2 - s - l),
                    [e, 100 * n, 100 * i];
            }
            function a(t) {
                var e, n, i, a = t[0], r = t[1], o = t[2], l = Math.min(a, r, o), s = Math.max(a, r, o), u = s - l;
                return n = 0 == s ? 0 : u / s * 1e3 / 10, s == l ? e = 0 : a == s ? e = (r - o) / u : r == s ? e = 2 + (o - a) / u : o == s && (e = 4 + (a - r) / u),
                    e = Math.min(60 * e, 360), 0 > e && (e += 360), i = s / 255 * 1e3 / 10, [e, n, i];
            }
            function o(t) {
                var e = t[0], n = t[1], a = t[2], r = i(t)[0], o = 1 / 255 * Math.min(e, Math.min(n, a)), a = 1 - 1 / 255 * Math.max(e, Math.max(n, a));
                return [r, 100 * o, 100 * a];
            }
            function l(t) {
                var e, n, i, a, r = t[0] / 255, o = t[1] / 255, l = t[2] / 255;
                return a = Math.min(1 - r, 1 - o, 1 - l), e = (1 - r - a) / (1 - a) || 0, n = (1 - o - a) / (1 - a) || 0,
            ...
            function u(t) {
                ...
                e = e > .04045 ? Math.pow((e + .055) / 1.055, 2.4) : e / 12.92, n = n > .04045 ? Math.pow((n + .055) / 1.055, 2.4) : n / 12.92,
                    i = i > .04045 ? Math.pow((i + .055) / 1.055, 2.4) : i / 12.92;
                var a = .4124 * e + .3576 * n + .1805 * i, r = .2126 * e + .7152 * n + .0722 * i, o = .0193 * e + .1192 * n + .9505 * i;
                return [100 * a, 100 * r, 100 * o];
            }
            function d(t) {
                var e, n, i, a = u(t), r = a[0], o = a[1], l = a[2];
                return r /= 95.047, o /= 100, l /= 108.883, r = r > .008856 ? Math.pow(r, 1 / 3) : 7.787 * r + 16 / 116,
                    o = o > .008856 ? Math.pow(o, 1 / 3) : 7.787 * o + 16 / 116, l = l > .008856 ? Math.pow(l, 1 / 3) : 7.787 * l + 16 / 116,
                    e = 116 * o - 16, n = 500 * (r - o), i = 200 * (o - l), [e, n, i];
            }
            function c(t) {
                return B(d(t));
            }
            function h(t) {
                ...
                for (var u = 0; 3 > u; u++) i = o + 1 / 3 * -(u - 1), 0 > i && i++, i > 1 && i--,
            ...
            function f(t) {
                ...
                return 0 === r ? [0, 0, 0] : (r *= 2, a *= 1 >= r ? r : 2 - r, n = (r + a) / 2,
                    e = 2 * a / (r + a), [i, 100 * e, 100 * n]);
            }
            function p(t) {
                return o(h(t));
            }
            ...
            function x(t) {
                var e = t[0] / 60, n = t[1] / 100, i = t[2] / 100, a = Math.floor(e) % 6, r = e - Math.floor(e), o = 255 * i * (1 - n), l = 255 * i * (1 - n * r), s = 255 * i * (1 - n * (1 - r)), i = 255 * i;
                switch (a) {
                    case 0:
                        return [i, s, o];
            ...
            function y(t) {
                var e, n, i = t[0], a = t[1] / 100, r = t[2] / 100;
                return n = (2 - a) * r, e = a * r, e /= 1 >= n ? n : 2 - n, e = e || 0, n /= 2,
                    [i, 100 * e, 100 * n];
            }
            function k(t) {
                return o(x(t));
            ...
            function P(t) {
                ...
                return e = 1 - Math.min(1, a * (1 - l) + l), n = 1 - Math.min(1, r * (1 - l) + l),
                    i = 1 - Math.min(1, o * (1 - l) + l), [255 * e, 255 * n, 255 * i];
            }
            function _(t) {
                return i(P(t));
            }
            ...
            function L(t) {
                ...
                return e = 3.2406 * a + -1.5372 * r + o * -.4986, n = a * -.9689 + 1.8758 * r + .0415 * o,
                    i = .0557 * a + r * -.204 + 1.057 * o, e = e > .0031308 ? 1.055 * Math.pow(e, 1 / 2.4) - .055 : e = 12.92 * e,
                    n = n > .0031308 ? 1.055 * Math.pow(n, 1 / 2.4) - .055 : n = 12.92 * n, i = i > .0031308 ? 1.055 * Math.pow(i, 1 / 2.4) - .055 : i = 12.92 * i,
                    e = Math.min(Math.max(0, e), 1), n = Math.min(Math.max(0, n), 1), i = Math.min(Math.max(0, i), 1),
                    [255 * e, 255 * n, 255 * i];
            }
            function V(t) {
                var e, n, i, a = t[0], r = t[1], o = t[2];
                return a /= 95.047, r /= 100, o /= 108.883, a = a > .008856 ? Math.pow(a, 1 / 3) : 7.787 * a + 16 / 116,
                    r = r > .008856 ? Math.pow(r, 1 / 3) : 7.787 * r + 16 / 116, o = o > .008856 ? Math.pow(o, 1 / 3) : 7.787 * o + 16 / 116,
                    e = 116 * r - 16, n = 500 * (a - r), i = 200 * (r - o), [e, n, i];
            }
            function O(t) {
                return B(V(t));
            }
            function z(t) {
                ...
                return 8 >= r ? (n = 100 * r / 903.3, a = 7.787 * (n / 100) + 16 / 116) : (n = 100 * Math.pow((r + 16) / 116, 3),
                    a = Math.pow(n / 100, 1 / 3)), e = .008856 >= e / 95.047 ? e = 95.047 * (o / 500 + a - 16 / 116) / 7.787 : 95.047 * Math.pow(o / 500 + a, 3),
                    i = .008859 >= i / 108.883 ? i = 108.883 * (a - l / 200 - 16 / 116) / 7.787 : 108.883 * Math.pow(a - l / 200, 3),
                    [e, n, i];
            }
            function B(t) {
                var e, n, i, a = t[0], r = t[1], o = t[2];
                return e = Math.atan2(o, r), n = 360 * e / 2 / Math.PI, 0 > n && (n += 360), i = Math.sqrt(r * r + o * o),
                    [a, i, n];
            }
            function W(t) {
                return L(z(t));
        ...
        7: [function (t, e, n) {
            var i = t(28)();
            t(26)(i), t(40)(i), t(22)(i), t(25)(i), t(30)(i), t(21)(i), t(23)(i), t(24)(i),
                t(29)(i), t(32)(i), t(33)(i), t(31)(i), t(27)(i), t(34)(i), t(35)(i), t(36)(i),
                t(37)(i), t(38)(i), t(46)(i), t(44)(i), t(45)(i), t(47)(i), t(48)(i), t(49)(i),
                t(15)(i), t(16)(i), t(17)(i), t(18)(i), t(19)(i), t(20)(i), t(8)(i), t(9)(i), t(10)(i),
                t(11)(i), t(12)(i), t(13)(i), t(14)(i);
            var a = [];
        ...
        15: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                t.defaults.bar = {
                    ...
                    initialize: function () {
                        var e, n = this;
                        t.DatasetController.prototype.initialize.apply(n, arguments), e = n.getMeta(), e.stack = n.getDataset().stack,
                            e.bar = !0;
                    },
                    update: function (t) {
                    ...
                    updateElement: function (t, n, i) {
                        var a = this, r = a.chart, o = a.getMeta(), l = a.getDataset(), s = t.custom || {}, u = r.options.elements.rectangle;
                        t._xScale = a.getScaleForId(o.xAxisID), t._yScale = a.getScaleForId(o.yAxisID),
                            t._datasetIndex = a.index, t._index = n, t._model = {
                    ...
                    updateElementGeometry: function (t, e, n) {
                        var i = this, a = t._model, r = i.getValueScale(), o = r.getBasePixel(), l = r.isHorizontal(), s = i._ruler || i.getRuler(), u = i.calculateBarValuePixels(i.index, e), d = i.calculateBarIndexPixels(i.index, e, s);
                        a.horizontal = l, a.base = n ? o : u.base, a.x = l ? n ? o : u.head : d.center,
                            a.y = l ? d.center : n ? o : u.head, a.height = l ? d.size : void 0, a.width = l ? void 0 : d.size;
                    },
                    ...
                    getRuler: function () {
                        var t = this, n = t.getIndexScale(), i = n.options, a = t.getStackCount(), r = n.isHorizontal() ? n.width : n.height, o = r / n.ticks.length, l = o * i.categoryPercentage, s = l / a, u = s * i.barPercentage;
                    ...
                    calculateBarValuePixels: function (t, e) {
                        ...
                        if (g || void 0 === g && void 0 !== p) for (n = 0; t > n; ++n) i = u.getDatasetMeta(n),
                    ...
                    calculateBarIndexPixels: function (t, e, n) {
                        var i = this, a = n.scale, r = i.chart.isCombo, o = i.getStackIndex(t), l = a.getPixelForValue(null, e, t, r), s = n.barSize;
                        return l -= r ? n.tickSize / 2 : 0, l += n.fullBarSize * o, l += n.categorySpacing / 2,
                            l += n.barSpacing / 2, {
                            size: s,
                            base: l,
                            head: l + s,
                    ...
                    removeHoverStyle: function (t) {
                        var n = this.chart.data.datasets[t._datasetIndex], i = t._index, a = t.custom || {}, r = t._model, o = this.chart.options.elements.rectangle;
            ...
            e.exports = function (t) {
                ...
                t.defaults.bubble = {
                    ...
                    updateElement: function (n, i, a) {
                        var r = this, o = r.getMeta(), l = r.getScaleForId(o.xAxisID), s = r.getScaleForId(o.yAxisID), u = n.custom || {}, d = r.getDataset(), c = d.data[i], h = r.chart.options.elements.point, f = r.index;
                        e.extend(n, {
                            _xScale: l,
                            _yScale: s,
                            _datasetIndex: f,
            ...
            e.exports = function (t) {
                ...
                n.doughnut = {
                    ...
                    legendCallback: function (t) {
                        ...
                        if (i.length) for (var r = 0; r < i[0].data.length; ++r) e.push('<li><span style="background-color:' + i[0].backgroundColor[r] + '"></span>'),
                    ...
                    legend: {
                        labels: {
                            generateLabels: function (t) {
                                ...
                                return n.labels.length && n.datasets.length ? n.labels.map(function (i, a) {
                                    var r = t.getDatasetMeta(0), o = n.datasets[0], l = r.data[a], s = l && l.custom || {}, u = e.getValueAtIndexOrDefault, d = t.options.elements.arc, c = s.backgroundColor ? s.backgroundColor : u(o.backgroundColor, a, d.backgroundColor), h = s.borderColor ? s.borderColor : u(o.borderColor, a, d.borderColor), f = s.borderWidth ? s.borderWidth : u(o.borderWidth, a, d.borderWidth);
                                    return {
                                        text: i,
                                        fillStyle: c,
                                        strokeStyle: h,
                        ...
                        onClick: function (t, e) {
                            ...
                            for (n = 0, i = (o.data.datasets || []).length; i > n; ++n) a = o.getDatasetMeta(n),
                    ...
                    update: function (t) {
                        var n = this, i = n.chart, a = i.chartArea, r = i.options, o = r.elements.arc, l = a.right - a.left - o.borderWidth, s = a.bottom - a.top - o.borderWidth, u = Math.min(l, s), d = {
                            x: 0,
                            y: 0
                        }, c = n.getMeta(), h = r.cutoutPercentage, f = r.circumference;
                        if (f < 2 * Math.PI) {
                            ...
                            var p = g + f, m = {
                                ...
                                x: Math.cos(p),
                                y: Math.sin(p)
                            }, b = 0 >= g && p >= 0 || g <= 2 * Math.PI && 2 * Math.PI <= p, x = g <= .5 * Math.PI && .5 * Math.PI <= p || g <= 2.5 * Math.PI && 2.5 * Math.PI <= p, y = g <= -Math.PI && -Math.PI <= p || g <= Math.PI && Math.PI <= p, k = g <= .5 * -Math.PI && .5 * -Math.PI <= p || g <= 1.5 * Math.PI && 1.5 * Math.PI <= p, w = h / 100, M = {
                        ...
                        i.borderWidth = n.getMaxBorderWidth(c.data), i.outerRadius = Math.max((u - i.borderWidth) / 2, 0),
                            i.innerRadius = Math.max(h ? i.outerRadius / 100 * h : 0, 0), i.radiusLength = (i.outerRadius - i.innerRadius) / i.getVisibleDatasetCount(),
                            i.offsetX = d.x * i.outerRadius, i.offsetY = d.y * i.outerRadius, c.total = n.calculateTotal(),
                            n.outerRadius = i.outerRadius - i.radiusLength * n.getRingIndex(n.index), n.innerRadius = Math.max(n.outerRadius - i.radiusLength, 0),
                            e.each(c.data, function (e, i) {
                                n.updateElement(e, i, t);
                            });
                    },
                    updateElement: function (t, n, i) {
                        var a = this, r = a.chart, o = r.chartArea, l = r.options, s = l.animation, u = (o.left + o.right) / 2, d = (o.top + o.bottom) / 2, c = l.rotation, h = l.rotation, f = a.getDataset(), g = i && s.animateRotate ? 0 : t.hidden ? 0 : a.calculateCircumference(f.data[n]) * (l.circumference / (2 * Math.PI)), p = i && s.animateScale ? 0 : a.innerRadius, m = i && s.animateScale ? 0 : a.outerRadius, v = e.getValueAtIndexOrDefault;
                        e.extend(t, {
                        ...
                        var b = t._model;
                        this.removeHoverStyle(t), i && s.animateRotate || (0 === n ? b.startAngle = l.rotation : b.startAngle = a.getMeta().data[n - 1]._model.endAngle,
                    ...
                    getMaxBorderWidth: function (t) {
                        for (var e, n, i = 0, a = this.index, r = t.length, o = 0; r > o; o++) e = t[o]._model ? t[o]._model.borderWidth : 0,
                            n = t[o]._chart ? t[o]._chart.config.data.datasets[a].hoverBorderWidth : 0, i = e > i ? e : i,
                            i = n > i ? n : i;
                        return i;
                    }
                });
            ...
            e.exports = function (t) {
                ...
                t.defaults.line = {
                    ...
                    update: function (t) {
                        ...
                        for (g && (r = s.custom || {}, void 0 !== f.tension && void 0 === f.lineTension && (f.lineTension = f.tension),
                            s._scale = h, s._datasetIndex = o.index, s._children = u, s._model = {
                    ...
                    updateElement: function (t, e, i) {
                        ...
                        void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius), void 0 !== u.hitRadius && void 0 === u.pointHitRadius && (u.pointHitRadius = u.hitRadius),
                            a = f.getPixelForValue("object" == typeof c ? c : NaN, e, d, m), r = i ? h.getBasePixel() : o.calculatePointY(c, e, d),
                            t._xScale = f, t._yScale = h, t._datasetIndex = d, t._index = e, t._model = {
                                x: a,
                                y: r,
                    ...
                    updateBezierControlPoints: function () {
                        ...
                        })), "monotone" === s.dataset._model.cubicInterpolationMode) n.splineCurveMonotone(d); else for (e = 0,
                            i = d.length; i > e; ++e) a = d[e], r = a._model, o = n.splineCurve(n.previousItem(d, e)._model, r, n.nextItem(d, e)._model, s.dataset._model.tension),
                                r.controlPointPreviousX = o.previous.x, r.controlPointPreviousY = o.previous.y,
                                r.controlPointNextX = o.next.x, r.controlPointNextY = o.next.y;
                        if (l.chart.options.elements.line.capBezierPoints) for (e = 0, i = d.length; i > e; ++e) r = d[e]._model,
                            r.controlPointPreviousX = t(r.controlPointPreviousX, u.left, u.right), r.controlPointPreviousY = t(r.controlPointPreviousY, u.top, u.bottom),
                            r.controlPointNextX = t(r.controlPointNextX, u.left, u.right), r.controlPointNextY = t(r.controlPointNextY, u.top, u.bottom);
                    },
                    draw: function () {
                        var n = this, i = n.chart, a = n.getMeta(), r = a.data || [], o = i.chartArea, l = r.length, s = 0;
                        for (t.canvasHelpers.clipArea(i.ctx, o), e(n.getDataset(), i.options) && a.dataset.draw(),
                            t.canvasHelpers.unclipArea(i.ctx); l > s; ++s) r[s].draw(o);
                    },
                    setHoverStyle: function (t) {
                    ...
                    removeHoverStyle: function (t) {
                        ...
                        void 0 !== i.radius && void 0 === i.pointRadius && (i.pointRadius = i.radius), o.radius = r.radius || n.getValueAtIndexOrDefault(i.pointRadius, a, e.chart.options.elements.point.radius),
                            o.backgroundColor = e.getPointBackgroundColor(t, a), o.borderColor = e.getPointBorderColor(t, a),
        ...
        19: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                t.defaults.polarArea = {
                    ...
                    legend: {
                        labels: {
                            generateLabels: function (t) {
                                var n = t.data;
                                return n.labels.length && n.datasets.length ? n.labels.map(function (i, a) {
                                    var r = t.getDatasetMeta(0), o = n.datasets[0], l = r.data[a], s = l.custom || {}, u = e.getValueAtIndexOrDefault, d = t.options.elements.arc, c = s.backgroundColor ? s.backgroundColor : u(o.backgroundColor, a, d.backgroundColor), h = s.borderColor ? s.borderColor : u(o.borderColor, a, d.borderColor), f = s.borderWidth ? s.borderWidth : u(o.borderWidth, a, d.borderWidth);
                                    return {
                                        text: i,
                                        fillStyle: c,
                                        strokeStyle: h,
                    ...
                    linkScales: e.noop,
                    update: function (t) {
                        var n = this, i = n.chart, a = i.chartArea, r = n.getMeta(), o = i.options, l = o.elements.arc, s = Math.min(a.right - a.left, a.bottom - a.top);
                        i.outerRadius = Math.max((s - l.borderWidth / 2) / 2, 0), i.innerRadius = Math.max(o.cutoutPercentage ? i.outerRadius / 100 * o.cutoutPercentage : 1, 0),
                            i.radiusLength = (i.outerRadius - i.innerRadius) / i.getVisibleDatasetCount(), n.outerRadius = i.outerRadius - i.radiusLength * n.index,
                            n.innerRadius = n.outerRadius - i.radiusLength, r.count = n.countVisibleElements(),
                    ...
                    updateElement: function (t, n, i) {
                        ...
                        var b = l.startAngle, x = t.hidden ? 0 : u.getDistanceFromCenterForValue(o.data[n]), y = b + h * p, k = y + (t.hidden ? 0 : h), w = s.animateScale ? 0 : u.getDistanceFromCenterForValue(o.data[n]);
                        e.extend(t, {
                            _datasetIndex: a.index,
                            _index: n,
                            _scale: u,
        ...
        20: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                t.defaults.radar = {
                    ...
                    linkScales: e.noop,
                    update: function (t) {
                        var n = this, i = n.getMeta(), a = i.dataset, r = i.data, o = a.custom || {}, l = n.getDataset(), s = n.chart.options.elements.line, u = n.chart.scale;
                    ...
                    updateElement: function (t, n, i) {
                        var a = this, r = t.custom || {}, o = a.getDataset(), l = a.chart.scale, s = a.chart.options.elements.point, u = l.getPointPositionForValue(n, o.data[n]);
                    ...
                    updateBezierControlPoints: function () {
                        ...
                        e.each(n.data, function (i, a) {
                            var r = i._model, o = e.splineCurve(e.previousItem(n.data, a, !0)._model, r, e.nextItem(n.data, a, !0)._model, r.tension);
                            r.controlPointPreviousX = Math.max(Math.min(o.previous.x, t.right), t.left), r.controlPointPreviousY = Math.max(Math.min(o.previous.y, t.bottom), t.top),
                                r.controlPointNextX = Math.max(Math.min(o.next.x, t.right), t.left), r.controlPointNextY = Math.max(Math.min(o.next.y, t.bottom), t.top),
                                i.pivot();
                        });
                    },
                    setHoverStyle: function (t) {
                    ...
                    removeHoverStyle: function (t) {
                        var n = this.chart.data.datasets[t._datasetIndex], i = t.custom || {}, a = t._index, r = t._model, o = this.chart.options.elements.point;
        ...
        21: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.animation = {
                    ...
                    advance: function (t) {
                        for (var n, i, a = this.animations, r = 0; r < a.length;) n = a[r], i = n.chart,
                            n.currentStep = (n.currentStep || 0) + t, n.currentStep = Math.min(n.currentStep, n.numSteps),
                            e.callback(n.render, [i, n], i), e.callback(n.onAnimationProgress, [n], i),
                            n.currentStep >= n.numSteps ? (e.callback(n.onAnimationComplete, [n], i), i.animating = !1,
                                a.splice(r, 1)) : ++r;
                    }
                ...
                e.drawPoint = function (e, n, i, a, r) {
                    ...
                    if (!(isNaN(i) || 0 >= i)) {
                        switch (n) {
                            ...
                            case "triangle":
                                e.beginPath(), l = 3 * i / Math.sqrt(3), d = l * Math.sqrt(3) / 2, e.moveTo(a - l / 2, r + d / 3),
                                    e.lineTo(a + l / 2, r + d / 3), e.lineTo(a, r - 2 * d / 3), e.closePath(), e.fill();
                                break;
                            ...
                            case "rectRot":
                                c = 1 / Math.SQRT2 * i, e.beginPath(), e.moveTo(a - c, r), e.lineTo(a, r + c), e.lineTo(a + c, r),
                                    e.lineTo(a, r - c), e.closePath(), e.fill();
                                break;

                            case "cross":
                                e.beginPath(), e.moveTo(a, r + i), e.lineTo(a, r - i), e.moveTo(a - i, r), e.lineTo(a + i, r),
                                    e.closePath();
                                break;

                            case "crossRot":
                                e.beginPath(), s = Math.cos(Math.PI / 4) * i, u = Math.sin(Math.PI / 4) * i, e.moveTo(a - s, r - u),
                                    e.lineTo(a + s, r + u), e.moveTo(a - s, r + u), e.lineTo(a + s, r - u), e.closePath();
                                break;

                            case "star":
                                e.beginPath(), e.moveTo(a, r + i), e.lineTo(a, r - i), e.moveTo(a - i, r), e.lineTo(a + i, r),
                                    s = Math.cos(Math.PI / 4) * i, u = Math.sin(Math.PI / 4) * i, e.moveTo(a - s, r - u),
                                    e.lineTo(a + s, r + u), e.moveTo(a - s, r + u), e.lineTo(a + s, r - u), e.closePath();
                                break;
        ...
        23: [function (t, e, n) {
            ...
            e.exports = function (t) {
                function e(e) {
                    e = e || {};
                    var n = e.data = e.data || {};
                    return n.datasets = n.datasets || [], n.labels = n.labels || [], e.options = a.configMerge(t.defaults.global, t.defaults[e.type], e.options || {}),
                        e;
                }
                function n(t) {
                    var e = t.options;
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, a.extend(t.prototype, {
                    construct: function (n, i) {
                        ...
                        return r.id = a.uid(), r.ctx = l, r.canvas = s, r.config = i, r.width = d, r.height = u,
                            r.aspectRatio = u ? d / u : null, r.options = i.options, r._bufferedRender = !1,
                            r.chart = r, r.controller = r, t.instances[r.id] = r, Object.defineProperty(r, "data", {
                                get: function () {
                    ...
                    initialize: function () {
                        var t = this;
                        return r.notify(t, "beforeInit"), a.retinaScale(t), t.bindEvents(), t.options.responsive && t.resize(!0),
                            t.ensureScalesHaveIDs(), t.buildScales(), t.initToolTip(), r.notify(t, "afterInit"),
                            t;
                    },
                    clear: function () {
                    ...
                    resize: function (t) {
                        var e = this, n = e.options, i = e.canvas, o = n.maintainAspectRatio && e.aspectRatio || null, l = Math.floor(a.getMaximumWidth(i)), s = Math.floor(o ? l / o : a.getMaximumHeight(i));
                        if ((e.width !== l || e.height !== s) && (i.width = e.width = l, i.height = e.height = s,
                            i.style.width = l + "px", i.style.height = s + "px", a.retinaScale(e), !t)) {
                            var u = {
                                width: l,
                                height: s
                            };
                            r.notify(e, "resize", [u]), e.options.onResize && e.options.onResize(e, u), e.stop(),
                    ...
                    buildScales: function () {
                        ...
                        n.scales && (o = o.concat((n.scales.xAxes || []).map(function (t) {
                            ...
                            var o = n.options, l = a.getValueOrDefault(o.type, n.dtype), s = t.scaleService.getScaleConstructor(l);
                            if (s) {
                    ...
                    updateLayout: function () {
                        ...
                        r.notify(e, "beforeLayout") !== !1 && (t.layoutService.update(this, this.width, this.height),
                            r.notify(e, "afterScaleUpdate"), r.notify(e, "afterLayout"));
                    },
                    ...
                    destroy: function () {
                        ...
                        for (l.stop(), n = 0, i = l.data.datasets.length; i > n; ++n) e = l.getDatasetMeta(n),
                            e.controller && (e.controller.destroy(), e.controller = null);
                        s && (l.unbindEvents(), a.clear(l), o.releaseContext(l.ctx), l.canvas = null, l.ctx = null),
                            r.notify(l, "destroy"), delete t.instances[l.id];
                    },
                    ...
                    eventHandler: function (t) {
                        ...
                        if (r.notify(e, "beforeEvent", [t]) !== !1) {
                            ...
                            return a ? e.render(a.duration, a.lazy) : i && !e.animating && (e.stop(), e.render(e.options.hover.animationDuration, !0)),
                    ...
                    handleEvent: function (t) {
                        ...
                        return e.lastActive = e.lastActive || [], "mouseout" === t.type ? e.active = [] : e.active = e.getElementsAtEventForMode(t, i.mode, i),
                            i.onHover && i.onHover.call(e, t["native"], e.active), ("mouseup" === t.type || "click" === t.type) && n.onClick && n.onClick.call(e, t["native"], e.active),
                            e.lastActive.length && e.updateHoverStyle(e.lastActive, i.mode, !1), e.active.length && i.mode && e.updateHoverStyle(e.active, i.mode, !0),
                            r = !a.arrayEquals(e.active, e.lastActive), e.lastActive = e.active, r;
                    }
                }), t.Controller = t;
            };
        }, {}],
            ...
            e.exports = function (t) {
                ...
                t.DatasetController = function (t, e) {
                    ...
                    removeHoverStyle: function (t, e) {
                        var n = this.chart.data.datasets[t._datasetIndex], a = t._index, r = t.custom || {}, o = i.getValueAtIndexOrDefault, l = t._model;
                    ...
                    setHoverStyle: function (t) {
                        var e = this.chart.data.datasets[t._datasetIndex], n = t._index, a = t.custom || {}, r = i.getValueAtIndexOrDefault, o = i.getHoverColor, l = t._model;
        ...
        25: [function (t, e, n) {
            ...
            e.exports = function (t) {
                function e(t, e, n, a) {
                    ...
                    for (r = 0, o = g.length; o > r; ++r) if (l = g[r], d = n[l], e.hasOwnProperty(l) || (e[l] = d),
                        s = e[l], s !== d && "_" !== l[0]) {
                ...
                t.elements = {}, t.Element = function (t) {
                    ...
                    transition: function (t) {
                        ...
                        return i && 1 !== t ? (r || (r = n._view = {}), a || (a = n._start = {}), e(a, r, i, t),
                            n) : (n._view = i, n._start = null, n);
                    },
        ...
        26: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                function a(t, i, a) {
                    var r = document.defaultView, o = t.parentNode, l = r.getComputedStyle(t)[i], s = r.getComputedStyle(o)[i], u = n(l), d = n(s), c = Number.POSITIVE_INFINITY;
                ...
                r.each = function (t, e, n, i) {
                    ...
                    return r.each(n, function (e, n) {
                        "xAxes" === n || "yAxes" === n ? i.hasOwnProperty(n) ? r.each(e, function (e, a) {
                            var o = r.getValueOrDefault(e.type, "xAxes" === n ? "category" : "linear"), l = t.scaleService.getScaleDefaults(o);
                    ...
                    return i.prototype = e.prototype, n.prototype = new i(), n.extend = r.inherits,
                        t && r.extend(n.prototype, t), n.__super__ = e.prototype, n;
                    ...
                    var a = t.skip ? e : t, r = e, o = n.skip ? e : n, l = Math.sqrt(Math.pow(r.x - a.x, 2) + Math.pow(r.y - a.y, 2)), s = Math.sqrt(Math.pow(o.x - r.x, 2) + Math.pow(o.y - r.y, 2)), u = l / (l + s), d = s / (l + s);
                    ...
                    var u, d, c, h;
                    for (e = 0; l - 1 > e; ++e) i = o[e], a = o[e + 1], i.model.skip || a.model.skip || (r.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = a.mK = 0 : (u = i.mK / i.deltaK,
                        d = a.mK / i.deltaK, h = Math.pow(u, 2) + Math.pow(d, 2), 9 >= h || (c = 3 / Math.sqrt(h),
                            i.mK = u * c * i.deltaK, a.mK = d * c * i.deltaK)));
                    var f;
                    for (e = 0; l > e; ++e) i = o[e], i.model.skip || (n = e > 0 ? o[e - 1] : null,
                        a = l - 1 > e ? o[e + 1] : null, n && !n.model.skip && (f = (i.model.x - n.model.x) / 3,
                            i.model.controlPointPreviousX = i.model.x - f, i.model.controlPointPreviousY = i.model.y - f * i.mK),
                        a && !a.model.skip && (f = (a.model.x - i.model.x) / 3, i.model.controlPointNextX = i.model.x + f,
                ...
                var o = r.easingEffects = {
                    ...
                    easeInElastic: function (t) {
                        ...
                        return 0 === t ? 0 : 1 === (t /= 1) ? 1 : (n || (n = .3), i < Math.abs(1) ? (i = 1,
                            e = n / 4) : e = n / (2 * Math.PI) * Math.asin(1 / i), -(i * Math.pow(2, 10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / n)));
                    },
                    easeOutElastic: function (t) {
                        var e = 1.70158, n = 0, i = 1;
                        return 0 === t ? 0 : 1 === (t /= 1) ? 1 : (n || (n = .3), i < Math.abs(1) ? (i = 1,
                            e = n / 4) : e = n / (2 * Math.PI) * Math.asin(1 / i), i * Math.pow(2, -10 * t) * Math.sin((1 * t - e) * (2 * Math.PI) / n) + 1);
                    },
                    easeInOutElastic: function (t) {
                        var e = 1.70158, n = 0, i = 1;
                        return 0 === t ? 0 : 2 === (t /= .5) ? 1 : (n || (n = 1 * (.3 * 1.5)), i < Math.abs(1) ? (i = 1,
                            e = n / 4) : e = n / (2 * Math.PI) * Math.asin(1 / i), 1 > t ? -.5 * (i * Math.pow(2, 10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / n)) : i * Math.pow(2, -10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / n) * .5 + 1);
                    },
                ...
                r.requestAnimFrame = function () {
                    ...
                    var u = parseFloat(r.getStyle(o, "padding-left")), d = parseFloat(r.getStyle(o, "padding-top")), c = parseFloat(r.getStyle(o, "padding-right")), h = parseFloat(r.getStyle(o, "padding-bottom")), f = l.right - l.left - u - c, g = l.bottom - l.top - d - h;
                    ...
                    var e = t.parentNode, n = parseInt(r.getStyle(e, "padding-left"), 10), i = parseInt(r.getStyle(e, "padding-right"), 10), a = e.clientWidth - n - i, o = r.getConstraintWidth(t);
                    return isNaN(o) ? a : Math.min(a, o);
                }, r.getMaximumHeight = function (t) {
                    var e = t.parentNode, n = parseInt(r.getStyle(e, "padding-top"), 10), i = parseInt(r.getStyle(e, "padding-bottom"), 10), a = e.clientHeight - n - i, o = r.getConstraintHeight(t);
                    return isNaN(o) ? a : Math.min(a, o);
                    ...
                    if (1 !== e) {
                        ...
                        n.height = i * e, n.width = a * e, t.ctx.scale(e, e), n.style.height = i + "px",
                            n.style.width = a + "px";
                    }
                }, r.clear = function (t) {
                    ...
                    t.beginPath(), t.moveTo(e + r, n), t.lineTo(e + i - r, n), t.quadraticCurveTo(e + i, n, e + i, n + r),
                        t.lineTo(e + i, n + a - r), t.quadraticCurveTo(e + i, n + a, e + i - r, n + a),
                        t.lineTo(e + r, n + a), t.quadraticCurveTo(e, n + a, e, n + a - r), t.lineTo(e, n + r),
        ...
        27: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                function n(t, e) {
                    ...
                    for (i = 0, r = l.length; r > i; ++i) if (t.isDatasetVisible(i)) for (n = t.getDatasetMeta(i),
                        a = 0, o = n.data.length; o > a; ++a) {
                        var s = n.data[a];
                        s._view.skip || e(s);
                    }
                }
                ...
                return t.defaults = {
                    global: {
                        ...
                        legendCallback: function (t) {
                            var e = [];
                            e.push('<ul class="' + t.id + '-legend">');
                            for (var n = 0; n < t.data.datasets.length; n++) e.push('<li><span style="background-color:' + t.data.datasets[n].backgroundColor + '"></span>'),
                                t.data.datasets[n].label && e.push(t.data.datasets[n].label), e.push("</li>");
                            return e.push("</ul>"), e.join("");
                        }
                    }
                }, t.Chart = t, t;
        ...
        29: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                t.layoutService = {
                    defaults: {},
                    addBox: function (t, e) {
                        t.boxes || (t.boxes = []), e.fullWidth = e.fullWidth || !1, e.position = e.position || "top",
                    ...
                    configure: function (t, e, n) {
                        for (var i, a = ["fullWidth", "position", "weight"], r = a.length, o = 0; r > o; ++o) i = a[o],
                            n.hasOwnProperty(i) && (e[i] = n[i]);
                    },
                    update: function (t, a, r) {
                        function o(t) {
                            var e, n = t.isHorizontal();
                            n ? (e = t.update(t.fullWidth ? k : I, D), A -= e.height) : (e = t.update(C, S),
                                I -= e.width), P.push({
                                    horizontal: n,
                                    minSize: e,
                                    box: t
                        ...
                        function u(t) {
                            t.isHorizontal() ? (t.left = t.fullWidth ? h : L, t.right = t.fullWidth ? a - f : L + I,
                                t.top = q, t.bottom = q + t.height, q = t.bottom) : (t.left = H, t.right = H + t.width,
                                    t.top = O, t.bottom = O + A, H = t.right);
                        }
                        if (t) {
                            var d = t.options.layout, c = d ? d.padding : null, h = 0, f = 0, g = 0, p = 0;
                            isNaN(c) ? (h = c.left || 0, f = c.right || 0, g = c.top || 0, p = c.bottom || 0) : (h = c,
                                f = c, g = c, p = c);
                            var m = e(t.boxes, "left"), v = e(t.boxes, "right"), b = e(t.boxes, "top"), x = e(t.boxes, "bottom"), y = e(t.boxes, "chartArea");
                            n(m, !0), n(v, !1), n(b, !0), n(x, !1);
                            var k = a - h - f, w = r - g - p, M = k / 2, S = w / 2, C = (a - M) / (m.length + v.length), D = (r - S) / (b.length + x.length), I = k, A = w, P = [];
                            ...
                            i.each(m.concat(b), u), H += I, q += A, i.each(v, u), i.each(x, u), t.chartArea = {
                                ...
                                e.left = t.chartArea.left, e.top = t.chartArea.top, e.right = t.chartArea.right,
                                    e.bottom = t.chartArea.bottom, e.update(I, A);
                            });
                        }
                    }
                };
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.plugins = {}, t.plugins = {
                    ...
                    notify: function (t, e, n) {
                        ...
                        for (i = 0; u > i; ++i) if (a = s[i], r = a.plugin, l = r[e], "function" == typeof l && (o = [t].concat(n || []),
                            o.push(a.options), l.apply(r, o) === !1)) return !1;
                        return !0;
                    },
                    descriptors: function (n) {
                        var i = n._plugins || (n._plugins = {});
                        if (i.id === this._cacheId) return i.descriptors;
                        var a = [], r = [], o = n && n.config || {}, l = t.defaults.global.plugins, s = o.options && o.options.plugins || {};
        ...
        31: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                function n(e) {
                    var n = i.getValueOrDefault, a = t.defaults.global, r = n(e.fontSize, a.defaultFontSize), o = n(e.fontStyle, a.defaultFontStyle), l = n(e.fontFamily, a.defaultFontFamily);
                    return {
                        size: r,
                        style: o,
                        family: l,
                ...
                t.defaults.scale = {
                    ...
                    update: function (t, e, n) {
                        ...
                        return a.beforeUpdate(), a.maxWidth = t, a.maxHeight = e, a.margins = i.extend({
                            ...
                            top: 0,
                            bottom: 0
                        }, n), a.longestTextCache = a.longestTextCache || {}, a.beforeSetDimensions(), a.setDimensions(),
                            a.afterSetDimensions(), a.beforeDataLimits(), a.determineDataLimits(), a.afterDataLimits(),
                            a.beforeBuildTicks(), a.buildTicks(), a.afterBuildTicks(), a.beforeTickToLabelConversion(),
                            a.convertTicksToLabels(), a.afterTickToLabelConversion(), a.beforeCalculateTickRotation(),
                            a.calculateTickRotation(), a.afterCalculateTickRotation(), a.beforeFit(), a.fit(),
                            a.afterFit(), a.afterUpdate(), a.minSize;
                    },
                    ...
                    fit: function () {
                        var t = this, a = t.minSize = {
                            width: 0,
                            height: 0
                        }, r = t.options, o = r.ticks, l = r.scaleLabel, s = r.gridLines, u = r.display, d = t.isHorizontal(), c = n(o), h = 1.5 * n(l).size, f = r.gridLines.tickMarkLength;
                        if (d ? a.width = t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : a.width = u && s.drawTicks ? f : 0,
                            d ? a.height = u && s.drawTicks ? f : 0 : a.height = t.maxHeight, l.display && u && (d ? a.height += h : a.width += h),
                            o.display && u) {
                            ...
                            if (d) {
                                ...
                                var k = t.ticks[0], w = e(t.ctx, k, c.font), M = t.ticks[t.ticks.length - 1], S = e(t.ctx, M, c.font);
                            ...
                            } else o.mirror ? g = 0 : g += t.options.ticks.padding, a.width = Math.min(t.maxWidth, a.width + g),
                    ...
                    getPixelForTick: function (t, e) {
                        var n = this;
                        if (n.isHorizontal()) {
                            var i = n.width - (n.paddingLeft + n.paddingRight), a = i / Math.max(n.ticks.length - (n.options.gridLines.offsetGridLines ? 0 : 1), 1), r = a * t + n.paddingLeft;
                            e && (r += a / 2);
                    ...
                    draw: function (e) {
                        ...
                        if (r.display) {
                            ...
                            var m = i.getValueOrDefault(d.fontColor, u.defaultFontColor), v = n(d), b = c.drawTicks ? c.tickMarkLength : 0, x = i.getValueOrDefault(h.fontColor, u.defaultFontColor), y = n(h), k = i.toRadians(a.labelRotation), w = Math.cos(k), M = a.longestLabelWidth * w;
                            s.fillStyle = m;
                            var S = [];
                            if (p) {
                                if (o = !1, (M + d.autoSkipPadding) * a.ticks.length > a.width - (a.paddingLeft + a.paddingRight) && (o = 1 + Math.floor((M + d.autoSkipPadding) * a.ticks.length / (a.width - (a.paddingLeft + a.paddingRight)))),
                                    l && a.ticks.length > l) for (; !o || a.ticks.length / (o || 1) > l;) o || (o = 1),
                                        o += 1;
                                g || (o = !1);
                            }
                            var C = "right" === r.position ? a.left : a.right - b, D = "right" === r.position ? a.left + b : a.right, I = "bottom" === r.position ? a.top : a.bottom - b, A = "bottom" === r.position ? a.top + b : a.bottom;
                            if (i.each(a.ticks, function (t, n) {
                                if (void 0 !== t && null !== t) {
                                    var l = a.ticks.length === n + 1, s = o > 1 && n % o > 0 || n % o === 0 && n + o >= a.ticks.length;
                                    if ((!s || l) && void 0 !== t && null !== t) {
                                        var h, g, m, v;
                                        n === ("undefined" != typeof a.zeroLineIndex ? a.zeroLineIndex : 0) ? (h = c.zeroLineWidth,
                                            g = c.zeroLineColor, m = c.zeroLineBorderDash, v = c.zeroLineBorderDashOffset) : (h = i.getValueAtIndexOrDefault(c.lineWidth, n),
                                                g = i.getValueAtIndexOrDefault(c.color, n), m = i.getValueOrDefault(c.borderDash, u.borderDash),
                                                v = i.getValueOrDefault(c.borderDashOffset, u.borderDashOffset));
                                        var x, y, w, M, P, _, T, F, R, L, V = "middle", O = "middle";
                                        if (p) {
                                            "bottom" === r.position ? (O = f ? "middle" : "top", V = f ? "right" : "center",
                                                L = a.top + b) : (O = f ? "middle" : "bottom", V = f ? "left" : "center", L = a.bottom - b);
                                            var z = a.getPixelForTick(n) + i.aliasPixel(h);
                                            R = a.getPixelForTick(n, c.offsetGridLines) + d.labelOffset, x = w = P = T = z,
                                                y = I, M = A, _ = e.top, F = e.bottom;
                                        } else {
                                            var B, W = "left" === r.position, N = d.padding;
                                            d.mirror ? (V = W ? "left" : "right", B = N) : (V = W ? "right" : "left", B = b + N),
                                                R = W ? a.right - B : a.left + B;
                                            var E = a.getPixelForTick(n);
                                            E += i.aliasPixel(h), L = a.getPixelForTick(n, c.offsetGridLines), x = C, w = D,
                                                P = e.left, T = e.right, y = M = _ = F = E;
                                        }
                                        S.push({
                                            tx1: x,
                                            ty1: y,
                                ...
                                if (c.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor,
                                    s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset),
                                    s.beginPath(), c.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)),
                                    c.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()),
                                    d.display) {
                                    s.save(), s.translate(t.labelX, t.labelY), s.rotate(t.rotation), s.font = v.font,
                                        s.textBaseline = t.textBaseline, s.textAlign = t.textAlign;
                                    var e = t.label;
                                    if (i.isArray(e)) for (var n = 0, a = 0; n < e.length; ++n) s.fillText("" + e[n], 0, a),
                                        a += 1.5 * v.size; else s.fillText(e, 0, 0);
                                    s.restore();
                                }
                            }), h.display) {
                                var P, _, T = 0;
                                if (p) P = a.left + (a.right - a.left) / 2, _ = "bottom" === r.position ? a.bottom - y.size / 2 : a.top + y.size / 2; else {
                                    ...
                                    P = F ? a.left + y.size / 2 : a.right - y.size / 2, _ = a.top + (a.bottom - a.top) / 2,
                                        T = F ? -.5 * Math.PI : .5 * Math.PI;
                                }
                                s.save(), s.translate(P, _), s.rotate(T), s.textAlign = "center", s.textBaseline = "middle",
                                    s.fillStyle = x, s.font = y.font, s.fillText(h.labelString, 0, 0), s.restore();
                            }
                            if (c.drawBorder) {
                                ...
                                p ? (V = O = "top" === r.position ? a.bottom : a.top, V += z, O += z) : (R = L = "left" === r.position ? a.right : a.left,
                                    R += z, L += z), s.beginPath(), s.moveTo(R, V), s.lineTo(L, O), s.stroke();
                            }
                        }
                    }
                });
                ...
                t.Ticks = {
                    generators: {
                        ...
                        logarithmic: function (t, n) {
                            ...
                            0 === l ? (i = Math.floor(e.log10(n.minNotZero)), a = Math.floor(n.minNotZero / Math.pow(10, i)),
                                r.push(l), l = a * Math.pow(10, i)) : (i = Math.floor(e.log10(l)), a = Math.floor(l / Math.pow(10, i)));
        ...
        34: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                function r(t, e) {
                    ...
                    i += l * d, i += l ? (l - 1) * e.titleSpacing : 0, i += l ? e.titleMarginBottom : 0,
                        i += o * c, i += o ? (o - 1) * e.bodySpacing : 0, i += u ? e.footerMarginTop : 0,
                        i += u * h, i += u ? (u - 1) * e.footerSpacing : 0;
                    var f = 0, g = function (t) {
                        a = Math.max(a, n.measureText(t).width + f);
                    };
                    return n.font = s.fontString(d, e._titleFontStyle, e._titleFontFamily), s.each(e.title, g),
                        n.font = s.fontString(c, e._bodyFontStyle, e._bodyFontFamily), s.each(e.beforeBody.concat(e.afterBody), g),
                        f = e.displayColors ? c + 2 : 0, s.each(r, function (t) {
                            s.each(t.before, g), s.each(t.lines, g), s.each(t.after, g);
                        }), f = 0, n.font = s.fontString(h, e._footerFontStyle, e._footerFontFamily), s.each(e.footer, g),
                        a += 2 * e.xPadding, {
                        width: a,
                        height: i
                    };
                ...
                function o(t, e) {
                    ...
                    }, l(n.x) ? (r = "left", u(n.x) && (r = "center", o = c(n.y))) : s(n.x) && (r = "right",
                        d(n.x) && (r = "center", o = c(n.y)));
                    var g = t._options;
                    return {
                ...
                function l(t, e, n) {
                    var i = t.x, a = t.y, r = t.caretSize, o = t.caretPadding, l = t.cornerRadius, s = n.xAlign, u = n.yAlign, d = r + o, c = l + o;
                ...
                t.defaults.global.tooltips = {
                    ...
                    getTitle: function () {
                        var t = this, e = t._options, i = e.callbacks, a = i.beforeTitle.apply(t, arguments), r = i.title.apply(t, arguments), o = i.afterTitle.apply(t, arguments), l = [];
                    ...
                    getBody: function (t, e) {
                        ...
                        return s.each(t, function (t) {
                            ...
                            n(o.before, a.beforeLabel.call(i, t, e)), n(o.lines, a.label.call(i, t, e)), n(o.after, a.afterLabel.call(i, t, e)),
                                r.push(o);
                        }), r;
                    },
                    ...
                    update: function (e) {
                        ...
                        if (g.length) {
                            ...
                            }), f.title = d.getTitle(k, p), f.beforeBody = d.getBeforeBody(k, p), f.body = d.getBody(k, p),
                                f.afterBody = d.getAfterBody(k, p), f.footer = d.getFooter(k, p), f.x = Math.round(x.x),
                                f.y = Math.round(x.y), f.caretPadding = c.caretPadding, f.labelColors = y, f.dataPoints = k,
                                b = r(this, f), m = o(this, b), v = l(f, b, m);
                        } else f.opacity = 0;
                        return f.xAlign = m.xAlign, f.yAlign = m.yAlign, f.x = v.x, f.y = v.y, f.width = b.width,
                            f.height = b.height, f.caretX = x.x, f.caretY = x.y, d._model = f, e && c.custom && c.custom.call(d, f),
                            d;
                    },
                    ...
                    getCaretPosition: function (t, e, n) {
                        ...
                        if ("center" === h) l = g + m / 2, "left" === c ? (i = f, a = i - u, r = i, o = l + u,
                            s = l - u) : (i = f + p, a = i + u, r = i, o = l - u, s = l + u); else if ("left" === c ? (a = f + d + u,
                                i = a - u, r = a + u) : "right" === c ? (a = f + p - d - u, i = a - u, r = a + u) : (a = f + p / 2,
                                    i = a - u, r = a + u), "top" === h) o = g, l = o - u, s = o; else {
                            o = g + m, l = o + u, s = o;
                            var v = r;
                            r = i, i = v;
                        }
                    ...
                    drawTitle: function (t, n, i, a) {
                        ...
                        if (r.length) {
                            ...
                            var u, d;
                            for (u = 0, d = r.length; d > u; ++u) i.fillText(r[u], t.x, t.y), t.y += o + l,
                    ...
                    drawBody: function (t, n, i, a) {
                        ...
                        d = h ? r + 2 : 0, s.each(l, function (o, l) {
                            s.each(o.before, c), s.each(o.lines, function (o) {
                                h && (i.fillStyle = e(n.legendColorBackground, a), i.fillRect(t.x, t.y, r, r), i.strokeStyle = e(n.labelColors[l].borderColor, a),
                                    i.strokeRect(t.x, t.y, r, r), i.fillStyle = e(n.labelColors[l].backgroundColor, a),
                                    i.fillRect(t.x + 1, t.y + 1, r - 2, r - 2), i.fillStyle = u), c(o);
                            }), s.each(o.after, c);
                        }), d = 0, s.each(n.afterBody, c), t.y -= o;
                    },
                    drawFooter: function (t, n, i, a) {
                        var r = n.footer;
                        r.length && (t.y += n.footerMarginTop, i.textAlign = n._footerAlign, i.textBaseline = "top",
                            i.fillStyle = e(n.footerFontColor, a), i.font = s.fontString(n.footerFontSize, n._footerFontStyle, n._footerFontFamily),
                            s.each(r, function (e) {
                    ...
                    drawBackground: function (t, n, i, a, r) {
                        ...
                        i.beginPath(), i.moveTo(s + h, u), "top" === l && this.drawCaret(t, a), i.lineTo(s + d - h, u),
                            i.quadraticCurveTo(s + d, u, s + d, u + h), "center" === l && "right" === o && this.drawCaret(t, a),
                            ...
                            "center" === l && "left" === o && this.drawCaret(t, a), i.lineTo(s, u + h), i.quadraticCurveTo(s, u, s + h, u),
                    ...
                    draw: function () {
                        ...
                        if (0 !== e.opacity) {
                            ...
                            this._options.enabled && r && (this.drawBackground(i, e, t, n, a), i.x += e.xPadding,
                                i.y += e.yPadding, this.drawTitle(i, e, t, a), this.drawBody(i, e, t, a), this.drawFooter(i, e, t, a));
                        }
                    },
                    handleEvent: function (t) {
                        var e = this, n = e._options, i = !1;
                        if (e._lastActive = e._lastActive || [], "mouseout" === t.type ? e._active = [] : e._active = e._chart.getElementsAtEventForMode(t, n.mode, n),
                            i = !s.arrayEquals(e._active, e._lastActive), !i) return !1;
            ...
            e.exports = function (t) {
                ...
                n.elements.arc = {
                    ...
                    draw: function () {
                        ...
                        t.beginPath(), t.arc(e.x, e.y, e.outerRadius, n, i), t.arc(e.x, e.y, e.innerRadius, i, n, !0),
                            t.closePath(), t.strokeStyle = e.borderColor, t.lineWidth = e.borderWidth, t.fillStyle = e.backgroundColor,
                            t.fill(), t.lineJoin = "bevel", e.borderWidth && t.stroke();
                    }
                });
            };
        }, {}],
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.elements.line = {
                    ...
                    draw: function () {
                        ...
                        for (o._loop && d.length && d.push(d[0]), s.save(), s.lineCap = l.borderCapStyle || c.borderCapStyle,
                            s.setLineDash && s.setLineDash(l.borderDash || c.borderDash), s.lineDashOffset = l.borderDashOffset || c.borderDashOffset,
                            s.lineJoin = l.borderJoinStyle || c.borderJoinStyle, s.lineWidth = l.borderWidth || c.borderWidth,
                            s.strokeStyle = l.borderColor || n.defaultColor, s.beginPath(), h = -1, t = 0; t < d.length; ++t) i = d[t],
                                a = e.previousItem(d, t), r = i._view, 0 === t ? r.skip || (s.moveTo(r.x, r.y),
                                    h = t) : (a = -1 === h ? a : d[h], r.skip || (h !== t - 1 && !u || -1 === h ? s.moveTo(r.x, r.y) : e.canvas.lineTo(s, a._view, i._view),
                                        h = t));
                        s.stroke(), s.restore();
                    }
                });
        ...
        37: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                a.elements.point = {
                    ...
                    draw: function (e) {
                        var n = this._view, o = this._model, l = this._chart.ctx, s = n.pointStyle, u = n.radius, d = n.x, c = n.y, h = t.helpers.color, f = 1.01, g = 0;
                        n.skip || (l.strokeStyle = n.borderColor || r, l.lineWidth = i.getValueOrDefault(n.borderWidth, a.elements.point.borderWidth),
                            l.fillStyle = n.backgroundColor || r, void 0 !== e && (o.x < e.left || e.right * f < o.x || o.y < e.top || e.bottom * f < o.y) && (o.x < e.left ? g = (d - o.x) / (e.left - o.x) : e.right * f < o.x ? g = (o.x - d) / (o.x - e.right) : o.y < e.top ? g = (c - o.y) / (e.top - o.y) : e.bottom * f < o.y && (g = (o.y - c) / (o.y - e.bottom)),
                                g = Math.round(100 * g) / 100, l.strokeStyle = h(l.strokeStyle).alpha(g).rgbString(),
                                l.fillStyle = h(l.fillStyle).alpha(g).rgbString()), t.canvasHelpers.drawPoint(l, s, u, d, c));
                    }
                });
            };
        }, {}],
                ...
                i.elements.rectangle = {
                    ...
                    draw: function () {
                        ...
                        if (u.horizontal ? (e = u.base, n = u.x, i = u.y - u.height / 2, a = u.y + u.height / 2,
                            r = n > e ? 1 : -1, o = 1, l = u.borderSkipped || "left") : (e = u.x - u.width / 2,
                                n = u.x + u.width / 2, i = u.y, a = u.base, r = 1, o = a > i ? 1 : -1, l = u.borderSkipped || "bottom"),
                            d) {
                            var c = Math.min(Math.abs(e - n), Math.abs(i - a));
                            d = d > c ? c : d;
                            var h = d / 2, f = e + ("left" !== l ? h * r : 0), g = n + ("right" !== l ? -h * r : 0), p = i + ("top" !== l ? h * o : 0), m = a + ("bottom" !== l ? -h * o : 0);
                            f !== g && (i = p, a = m), p !== m && (e = f, n = g);
                        }
                        s.beginPath(), s.fillStyle = u.backgroundColor, s.strokeStyle = u.borderColor, s.lineWidth = d;
                        var v = [[e, a], [e, i], [n, i], [n, a]], b = ["bottom", "left", "top", "right"], x = b.indexOf(l, 0);
                        -1 === x && (x = 0);
                        var y = t(0);
                        s.moveTo(y[0], y[1]);
        ...
        39: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                function r(t) {
                    ...
                    return e.className = "chartjs-hidden-iframe", e.style.cssText = "display:block;overflow:hidden;border:0;margin:0;top:0;left:0;bottom:0;right:0;height:100%;width:100%;position:absolute;pointer-events:none;z-index:-1;",
                        e.tabIndex = -1, s.addEvent(e, "load", function () {
                ...
                return {
                    ...
                    addEventListener: function (t, e, n) {
                        ...
                        var r = n._chartjs || (n._chartjs = {}), l = r.proxies || (r.proxies = {}), u = l[t.id + "_" + e] = function (e) {
                            n(a(e, t));
                        };
                        s.addEvent(i, e, u);
                    },
        ...
        41: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                function l(t, e, n, i, a, l) {
                    ...
                    for (t.beginPath(), s = 0, u = p + !!l; u > s; ++s) d = s % p, c = e[d]._view, h = n(c, d, i),
                        f = r(c), g = r(h), f && g ? (x = v.push(c), y = b.push(h)) : x && y && (m ? (f && v.push(c),
                            g && b.push(h)) : (o(t, v, b, x, y), x = y = 0, v = [], b = []));
                ...
                var s = t.defaults, u = t.helpers, d = {
                    dataset: function (t) {
                        var e = t.fill, n = t.chart, i = n.getDatasetMeta(e), a = i && n.isDatasetVisible(e), r = a && i.dataset._children || [];
                ...
                return {
                    ...
                    afterDatasetsUpdate: function (r, o) {
                        ...
                        for (s = 0; c > s; ++s) d = f[s], d && (d.fill = i(f, s, h), d.boundary = n(d),
                            d.mapper = a(d));
                    },
                    beforeDatasetDraw: function (t, e) {
                        var n = e.meta.$filler;
                        if (n) {
                            var i = n.el, a = i._view, r = i._children || [], o = n.mapper, u = a.backgroundColor || s.global.defaultColor;
        ...
        42: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                return t.defaults.global.legend = {
                    ...
                    update: function (t, e, n) {
                        var i = this;
                        return i.beforeUpdate(), i.maxWidth = t, i.maxHeight = e, i.margins = n, i.beforeSetDimensions(),
                    ...
                    beforeFit: r,
                    fit: function () {
                        var n = this, a = n.options, r = a.labels, o = a.display, l = n.ctx, s = t.defaults.global, u = i.getValueOrDefault, d = u(r.fontSize, s.defaultFontSize), c = u(r.fontStyle, s.defaultFontStyle), h = u(r.fontFamily, s.defaultFontFamily), f = i.fontString(d, c, h), g = n.legendHitBoxes = [], p = n.minSize, m = n.isHorizontal();
                        if (m ? (p.width = n.maxWidth, p.height = o ? 10 : 0) : (p.width = o ? 10 : 0, p.height = n.maxHeight),
                            o) if (l.font = f, m) {
                                ...
                                l.textAlign = "left", l.textBaseline = "top", i.each(n.legendItems, function (t, i) {
                                    ...
                                    v[v.length - 1] + o + r.padding >= n.width && (b += d + r.padding, v[v.length] = n.left),
                                        g[i] = {
                                            left: 0,
                                            top: 0,
                                            width: o,
                                ...
                                i.each(n.legendItems, function (t, n) {
                                    ...
                                    M + S > p.height && (k += w + r.padding, y.push(w), w = 0, M = 0), w = Math.max(w, a),
                                        M += S, g[n] = {
                                            left: 0,
                                            top: 0,
                                            width: a,
                    ...
                    draw: function () {
                        var n = this, a = n.options, r = a.labels, o = t.defaults.global, l = o.elements.line, s = n.width, u = n.lineWidths;
                        if (a.display) {
                            ...
                            c.textAlign = "left", c.textBaseline = "top", c.lineWidth = .5, c.strokeStyle = f,
                                c.fillStyle = f, c.font = v;
                            var b = e(r, g), x = n.legendHitBoxes, y = function (e, n, i) {
                                if (!(isNaN(b) || 0 >= b)) {
                                    c.save(), c.fillStyle = h(i.fillStyle, o.defaultColor), c.lineCap = h(i.lineCap, l.borderCapStyle),
                                        c.lineDashOffset = h(i.lineDashOffset, l.borderDashOffset), c.lineJoin = h(i.lineJoin, l.borderJoinStyle),
                                        c.lineWidth = h(i.lineWidth, l.borderWidth), c.strokeStyle = h(i.strokeStyle, o.defaultColor);
                                ...
                                c.fillText(n.text, b + g / 2 + t, e), n.hidden && (c.beginPath(), c.lineWidth = 2,
                                    c.moveTo(b + g / 2 + t, e + g / 2), c.lineTo(b + g / 2 + t + i, e + g / 2), c.stroke());
                            }, w = n.isHorizontal();
                            d = w ? {
                                x: n.left + (s - u[0]) / 2,
                                y: n.top + r.padding,
                            ...
                            i.each(n.legendItems, function (t, e) {
                                ...
                                w ? o + a >= s && (l = d.y += M, d.line++, o = d.x = n.left + (s - u[d.line]) / 2) : l + M > n.bottom && (o = d.x = o + n.columnWidths[d.line] + r.padding,
                                    l = d.y = n.top + r.padding, d.line++), y(o, l, t), x[e].left = o, x[e].top = l,
                                    k(o, l, t, i), w ? d.x += a + r.padding : d.y += M;
                            });
                        }
                    },
                    handleEvent: function (t) {
                    ...
                    beforeUpdate: function (e) {
                        ...
                        r ? (r = i.configMerge(t.defaults.global.legend, r), o ? (a.configure(e, o, r),
                            o.options = r) : n(e, r)) : o && (a.removeBox(e, o), delete e.legend);
                    },
        ...
        43: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                return t.defaults.global.title = {
                    ...
                    beforeFit: a,
                    fit: function () {
                        var e = this, i = n.getValueOrDefault, a = e.options, r = t.defaults.global, o = a.display, l = i(a.fontSize, r.defaultFontSize), s = e.minSize;
                        e.isHorizontal() ? (s.width = e.maxWidth, s.height = o ? l + 2 * a.padding : 0) : (s.width = o ? l + 2 * a.padding : 0,
                            s.height = e.maxHeight), e.width = s.width, e.height = s.height;
                    },
                    afterFit: a,
                    isHorizontal: function () {
                    ...
                    draw: function () {
                        ...
                        if (r.display) {
                            ...
                            i.fillStyle = a(r.fontColor, o.defaultFontColor), i.font = f, e.isHorizontal() ? (l = m + (b - m) / 2,
                                s = p + (v - p) / 2, u = b - m) : (l = "left" === r.position ? m + d / 2 : b - d / 2,
                                    s = p + (v - p) / 2, u = v - p, g = Math.PI * ("left" === r.position ? -.5 : .5)),
                                i.save(), i.translate(l, s), i.rotate(g), i.textAlign = "center", i.textBaseline = "middle",
                                i.fillText(r.text, 0, 0, u), i.restore();
                        }
                    }
                }), {
                    id: "title",
                    ...
                    beforeUpdate: function (a) {
                        ...
                        r ? (r = n.configMerge(t.defaults.global.title, r), o ? (i.configure(a, o, r), o.options = r) : e(a, r)) : o && (t.layoutService.removeBox(a, o),
                            delete a.titleBlock);
                    }
                };
            };
                ...
                var e = t.helpers, n = {
                    ...
                    determineDataLimits: function () {
                        ...
                        void 0 !== t.options.ticks.min && (i = e.indexOf(n, t.options.ticks.min), t.minIndex = -1 !== i ? i : t.minIndex),
                            ...
                            t.min = n[t.minIndex], t.max = n[t.maxIndex];
                    },
                    buildTicks: function () {
                    ...
                    getValueForPixel: function (t) {
                        ...
                        return t -= a ? n.left : n.top, n.options.gridLines.offsetGridLines && (t -= r / 2),
            ...
            e.exports = function (t) {
                var e = t.helpers, n = {
                    ...
                    determineDataLimits: function () {
                        ...
                        var n = this, i = n.options, a = n.chart, r = a.data, o = r.datasets, l = n.isHorizontal(), s = 0, u = 1;
                        ...
                        if (void 0 === d && e.each(o, function (e, n) {
                            ...
                            e.each(o, function (r, o) {
                                var l = a.getDatasetMeta(o), s = [l.type, void 0 === i.stacked && void 0 === l.stack ? o : "", l.stack].join(".");
                                void 0 === c[s] && (c[s] = {
                                    positiveValues: [],
                                    negativeValues: []
                                });
                    ...
                    getPixelForValue: function (t) {
                        ...
                        return n.isHorizontal() ? (e = n.left + n.width / r * (a - i), Math.round(e)) : (e = n.bottom - n.height / r * (a - i),
                            Math.round(e));
                    },
                    getValueForPixel: function (t) {
            ...
            e.exports = function (t) {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    ...
                    buildTicks: function () {
                        ...
                        n.handleDirectionalChanges(), n.max = e.max(l), n.min = e.min(l), a.reverse ? (l.reverse(),
                            n.start = n.max, n.end = n.min) : (n.start = n.min, n.end = n.max);
                    },
                    convertTicksToLabels: function () {
                        var e = this;
            ...
            e.exports = function (t) {
                var e = t.helpers, n = {
                    ...
                    determineDataLimits: function () {
                        ...
                        var n = this, i = n.options, a = i.ticks, r = n.chart, o = r.data, l = o.datasets, s = e.getValueOrDefault, u = n.isHorizontal();
                        ...
                        if (void 0 === d && e.each(l, function (e, n) {
                            ...
                            e.each(l, function (a, o) {
                                var l = r.getDatasetMeta(o), s = [l.type, void 0 === i.stacked && void 0 === l.stack ? o : "", l.stack].join(".");
                            ...
                            r.isDatasetVisible(a) && t(o) && e.each(i.data, function (t, e) {
                                var i = +n.getRightValue(t);
                                isNaN(i) || o.data[e].hidden || (null === n.min ? n.min = i : i < n.min && (n.min = i),
                                    null === n.max ? n.max = i : i > n.max && (n.max = i), 0 !== i && (null === n.minNotZero || i < n.minNotZero) && (n.minNotZero = i));
                            });
                        });
                        n.min = s(a.min, n.min), n.max = s(a.max, n.max), n.min === n.max && (0 !== n.min && null !== n.min ? (n.min = Math.pow(10, Math.floor(e.log10(n.min)) - 1),
                            n.max = Math.pow(10, Math.floor(e.log10(n.max)) + 1)) : (n.min = 1, n.max = 10));
                    },
                    buildTicks: function () {
                        var n = this, i = n.options, a = i.ticks, r = {
                            min: a.min,
                            max: a.max
                        }, o = n.ticks = t.Ticks.generators.logarithmic(r, n);
                        n.isHorizontal() || o.reverse(), n.max = e.max(o), n.min = e.min(o), a.reverse ? (o.reverse(),
                            n.start = n.max, n.end = n.min) : (n.start = n.min, n.end = n.max);
                    },
                    convertTicksToLabels: function () {
                    ...
                    getPixelForValue: function (t) {
                        ...
                        return r.isHorizontal() ? (a = e.log10(r.end) - e.log10(o), 0 === l ? i = r.left : (n = r.width,
                            i = r.left + n / a * (e.log10(l) - e.log10(o)))) : (n = r.height, 0 !== o || u.reverse ? 0 === r.end && u.reverse ? (a = e.log10(r.start) - e.log10(r.minNotZero),
                                i = l === r.end ? r.top : l === r.minNotZero ? r.top + .02 * n : r.top + .02 * n + .98 * n / a * (e.log10(l) - e.log10(r.minNotZero))) : 0 === l ? i = u.reverse ? r.top : r.bottom : (a = e.log10(r.end) - e.log10(o),
                                    n = r.height, i = r.bottom - n / a * (e.log10(l) - e.log10(o))) : (a = e.log10(r.end) - e.log10(r.minNotZero),
                    ...
                    getValueForPixel: function (t) {
                        ...
                        return a.isHorizontal() ? (i = a.width, n = a.start * Math.pow(10, (t - a.left) * r / i)) : (i = a.height,
                            n = Math.pow(10, (a.bottom - t) * r / i) / a.start), n;
                    }
                });
        ...
        48: [function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                function n(t) {
                    var e = t.options.pointLabels, n = f.getValueOrDefault(e.fontSize, g.defaultFontSize), i = f.getValueOrDefault(e.fontStyle, g.defaultFontStyle), a = f.getValueOrDefault(e.fontFamily, g.defaultFontFamily), r = f.fontString(n, i, a);
                    return {
                        size: n,
                        style: i,
                        family: a,
                ...
                function r(t) {
                    ...
                    for (r = 0; h > r; r++) {
                        ...
                        var g = t.getIndexAngle(r), p = f.toDegrees(g) % 360, m = a(p, l.x, o.w, 0, 180), v = a(p, l.y, o.h, 90, 270);
                        m.start < d.l && (d.l = m.start, c.l = g), m.end > d.r && (d.r = m.end, c.r = g),
                            v.start < d.t && (d.t = v.start, c.t = g), v.end > d.b && (d.b = v.end, c.b = g);
                    }
                ...
                function s(t, e, n, i) {
                    if (f.isArray(e)) for (var a = n.y, r = 1.5 * i, o = 0; o < e.length; ++o) t.fillText(e[o], n.x, a),
                        a += r; else t.fillText(e, n.x, n.y);
                }
                function u(t, e, n) {
                ...
                function c(t, n, i, a) {
                    var r = t.ctx;
                    if (r.strokeStyle = f.getValueAtIndexOrDefault(n.color, a - 1), r.lineWidth = f.getValueAtIndexOrDefault(n.lineWidth, a - 1),
                        t.options.gridLines.circular) r.beginPath(), r.arc(t.xCenter, t.yCenter, i, 0, 2 * Math.PI),
                ...
                var f = t.helpers, g = t.defaults.global, p = {
                    ...
                    determineDataLimits: function () {
                        ...
                        }), t.min = n === Number.POSITIVE_INFINITY ? 0 : n, t.max = i === Number.NEGATIVE_INFINITY ? 0 : i,
                    ...
                    setReductions: function (t, e, n) {
                        var i = this, a = e.l / Math.sin(n.l), r = Math.max(e.r - i.width, 0) / Math.sin(n.r), o = -e.t / Math.cos(n.t), l = -Math.max(e.b - i.height, 0) / Math.cos(n.b);
                        a = h(a), r = h(r), o = h(o), l = h(l), i.drawingArea = Math.min(Math.round(t - (a + r) / 2), Math.round(t - (o + l) / 2)),
                            i.setCenterPoint(a, r, o, l);
                    },
                    setCenterPoint: function (t, e, n, i) {
                        var a = this, r = a.width - e - a.drawingArea, o = t + a.drawingArea, l = n + a.drawingArea, s = a.height - i - a.drawingArea;
                        a.xCenter = Math.round((o + r) / 2 + a.left), a.yCenter = Math.round((l + s) / 2 + a.top);
                    },
                    getIndexAngle: function (t) {
                        var n = 2 * Math.PI / e(this), i = this.chart.options && this.chart.options.startAngle ? this.chart.options.startAngle : 0, a = i * Math.PI * 2 / 360;
                        return t * n + a;
                    },
                    ...
                    draw: function () {
                        ...
                        if (e.display) {
                            var r = t.ctx, o = a(i.fontSize, g.defaultFontSize), l = a(i.fontStyle, g.defaultFontStyle), s = a(i.fontFamily, g.defaultFontFamily), u = f.fontString(o, l, s);
        ...
        49: [function (t, e, n) {
            ...
            i = "function" == typeof i ? i : window.moment, e.exports = function (t) {
                ...
                function a(t, e, n, i) {
                    ...
                    if (a.steps) for (var d = a.steps.length, c = 0; d > c && o > i; c++) s = a.steps[c],
                        o = Math.ceil(u / (r * s)); else for (; o > i && i > 0;) ++s, o = Math.ceil(u / (r * s));
                    return s;
                }
                function r(t, e, n) {
                    var a = [];
                ...
                t.Ticks.generators.time = function (t, e) {
                    ...
                    return "week" === t.unit && o !== !1 ? (n = i(e.min).startOf("isoWeek").isoWeekday(o).valueOf(),
                        a = i(e.max).startOf("isoWeek").isoWeekday(o), e.max - a > 0 && a.add(1, "week"),
                        a = a.valueOf()) : (n = i(e.min).startOf(t.unit).valueOf(), a = i(e.max).startOf(t.unit),
                            e.max - a > 0 && a.add(1, t.unit), a = a.valueOf()), r(t, e, {
                                min: n,
                                max: a
                            });
                };
                var u = t.Scale.extend({
                    ...
                    determineDataLimits: function () {
                        ...
                        o.each(l.labels, function (o, l) {
                            var u = e(n, o);
                            u.isValid() && (i.round && u.startOf(i.round), t = u.valueOf(), a = Math.min(t, a),
                                r = Math.max(t, r), s.labels[l] = t);
                            ...
                            "object" == typeof l.data[0] && null !== l.data[0] && n.chart.isDatasetVisible(u) ? o.each(l.data, function (o, l) {
                                ...
                                s.isValid() && (i.round && s.startOf(i.round), t = s.valueOf(), a = Math.min(t, a),
                                    r = Math.max(t, r), d[l] = t);
                    ...
                    getLabelForIndex: function (t, n) {
                        var i = this, a = i.chart.data.labels && t < i.chart.data.labels.length ? i.chart.data.labels[t] : "", r = i.chart.data.datasets[n].data[t];
                        return null !== r && "object" == typeof r && (a = i.getRightValue(r)), i.options.time.tooltipFormat && (a = e(i, a).format(i.options.time.tooltipFormat)),
                            a;
                    },
                    tickFormatFunction: function (t, e, n) {
                        var i = t.format(this.displayFormat), a = this.options.ticks, r = o.getValueOrDefault(a.callback, a.userCallback);
                        return r ? r(i, e, n) : i;
                    },
                    convertTicksToLabels: function () {
                        var t = this;
                    ...
                    getPixelForValue: function (t, n, i) {
                        var a = this, r = null;
                        return void 0 !== n && void 0 !== i && (r = a._parsedData.datasets[i][n]), null === r && (t && t.isValid || (t = e(a, a.getRightValue(t))),
                            t && t.isValid && t.isValid() && (r = t.valueOf())), null !== r ? a.getPixelForOffset(r) : void 0;
                    },
                    getPixelForTick: function (t) {
                    ...
                    getLabelWidth: function (e) {
                        var n = this, i = n.options.ticks, a = n.ctx.measureText(e).width, r = Math.cos(o.toRadians(i.maxRotation)), l = Math.sin(o.toRadians(i.maxRotation)), s = o.getValueOrDefault(i.fontSize, t.defaults.global.defaultFontSize);
                        return a * r + s * l;
                    },
                    getLabelCapacity: function (t) {
                        var e = this;
                        e.displayFormat = e.options.time.displayFormats.millisecond;
                        var n = e.tickFormatFunction(i(t), 0, []), a = e.getLabelWidth(n), r = e.isHorizontal() ? e.width : e.height, o = r / a;
                        return o;
                    }
                });
